...
public class Search extends AppCompatActivity implements MyAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Store the initial home intent when it is created
        //Intent homeIntent = new Intent(getApplicationContext(), DisplaySongs.class);
        ...
        bottomNavigationView.setOnItemSelectedListener(item -> {
            ...
            if (id == R.id.navigation_home) {
                //startActivityWithTransition(homeIntent, false);
                finish();
                return true;
